<template>
	<view class="wrap">
		...
		<u-form class="form" :model="model" :rules="rules" ref="uForm">
			<u-form-item label="昵称" prop="userName" label-width="120">
				<u-input placeholder="请输入用户昵称" v-model="model.userName" type="text"></u-input>
			</u-form-item>
			...
			<u-form-item label="电话" prop="phone" label-width="120">
				<u-input placeholder="请输入办公电话" v-model="model.phone" type="text"></u-input>
			</u-form-item>
			<u-form-item label="签名" prop="sign" label-width="120">
				<u-input type="textarea" placeholder="请输入个性签名" v-model="model.sign" height="35" />
			</u-form-item>
